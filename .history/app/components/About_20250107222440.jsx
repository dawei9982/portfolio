    ...
    >
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='w-64 sm:w-80 rounded-3xl max-w-none'>
            <Image src={assets.user_image} alt='user' className='scale-125 h-80 w-full rounded-3xl'/>
        </motion.div>
        <motion.div
        initial={{opacity: 0}}
        whileInView={{opacity: 1}}
        ...
        className='flex-1'>
            ...
            className='my-6 text-gray-700 font-Ovo dark:text-white/80'>Tools I can use:</motion.h4>
            <motion.ul 
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}
            ...
            className='flex items-center gap-3 sm:gap-5'>
                {toolsData.map((tool, index)=>(
                    ...
                    border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500' //can change to positive translatey
                    key={index}>
